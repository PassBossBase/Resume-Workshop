    ...
    <AppShell>
      <PageContainer>
        ...
        <StickerCard className="mt-8 p-8 text-center md:p-12">
          <FileJson className="mx-auto mb-5 text-(--purple)" size={56} />
          ...
          <div className="mt-6 inline-block rounded-2xl border-2 border-black bg-(--yellow) px-5 py-2.5 text-sm font-bold shadow-[3px_3px_0_black]">
            敬请期待
          </div>
        </StickerCard>
      </PageContainer>
